...
namespace CocoloresPEP.Common.WpfCore.Service.MessageBox
{
    public class WpfMessageBoxService : IMessageBoxService
    {
        ...
        {
            ShowMessage(message, "Fehler", CustomDialogIcons.Stop);
        }
        ...
        {
            ShowMessage(message, "Warnung", CustomDialogIcons.Warning);
        }
        ...
        {
            System.Windows.MessageBox.Show(message, heading, MessageBoxButton.OK, GetImage(icon));
        }
